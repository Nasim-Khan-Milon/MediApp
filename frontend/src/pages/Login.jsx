        ...
        <form className='min-h[80vh] flex items-center'>
            <div className='flex flex-col gap-3 m-auto mt-20 items-start p-8 min-w-[340px] sm:min-w-96 border  border-gray-300 rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
...

                {
                    state === 'Login' ? (
                        role === 'Doctor' ? (
                            <p>Patient Login <span onClick={() => setRole('User')} className='text-primary underline cursor-pointer'>Click Here</span></p>
                        ) : (
                            <>
                                <p>
                                    Doctor Login <span onClick={() => setRole('Doctor')} className='text-primary underline cursor-pointer'>Click Here</span>
                                </p>
                                <p>
                                    Create an new account? <span onClick={() => setState('Sign Up')} className='text-primary underline cursor-pointer'>Click Here</span>
                                </p>
                            </>
